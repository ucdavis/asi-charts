...
<link href="https://cdn.datatables.net/select/1.3.2/css/select.jqueryui.min.css" rel="stylesheet">
...
<script src="https://cdn.datatables.net/searchpanes/1.2.1/js/searchPanes.jqueryui.min.js" type="text/javascript"></script>
<link href="https://cdn.datatables.net/searchpanes/1.1.1/css/searchPanes.dataTables.min.css" rel="stylesheet">   
      
<script src="https://cdn.datatables.net/select/1.3.2/js/dataTables.select.min.js" type="text/javascript"></script>
<link href="https://cdn.datatables.net/select/1.3.2/css/select.dataTables.min.css" rel="stylesheet">
